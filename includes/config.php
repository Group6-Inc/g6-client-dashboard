	...
	return [
		...
		'services' => [
			[
				...
				'cta_url'     => 'mailto:nate@group6inc.com?subject=Local%20SEO%20Inquiry',
				'highlight'   => true,
			],
			[
				...
				'icon'        => 'star',
				'cta_label'   => 'Learn More',
				'cta_url'     => 'mailto:nate@group6inc.com?subject=Reputation%20Management%20Inquiry',
				'highlight'   => false,
			],
			[
				'name'        => 'Content Marketing',
				'slug'        => 'content',
				'description' => 'Blog posts, landing pages, and content strategy to drive organic traffic.',
				'icon'        => 'file-text',
				'cta_label'   => 'Learn More',
				'cta_url'     => 'mailto:nate@group6inc.com?subject=Content%20Marketing%20Inquiry',
				'highlight'   => false,
			],
			[
				'name'        => 'Paid Advertising',
				'slug'        => 'paid-ads',
				'description' => 'Google Ads and social media campaigns that deliver measurable ROI.',
				'icon'        => 'trending-up',
				'cta_label'   => 'Learn More',
				'cta_url'     => 'mailto:nate@group6inc.com?subject=Paid%20Advertising%20Inquiry',
				'highlight'   => false,
			],
		],
